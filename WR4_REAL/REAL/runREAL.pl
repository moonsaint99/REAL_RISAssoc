...
# Extract year, month, and day from the argument
...
#$R = "0.5/0.3/0.025/0.025/5/360/180"; Jan 21 params
$R = "1/0.3/0.025/0.3/5/360/180/-79.1/180";
# -G(trx/trh/tdx/tdh)
$G = "0.5/0.3/0.01/0.01";
...
#$S = "4/0/4/0/1/0/1.6/0.5/4
$S = "4/0/4/0/2/0/2/0.25/0.5/10";
# is nrt=1.6 the right value?

$dir = "../Pick_PhaseNet/$year$mon$day";
